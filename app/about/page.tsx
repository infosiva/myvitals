...
export const metadata: Metadata = {
  title: "About | MyVitals",
  description: "About MyVitals — AI health tracker — log symptoms, track vitals and get personalised wellness insights.",
...
export default function AboutPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      <h1 className="text-3xl font-bold mb-6">About MyVitals</h1>

      <section className="mb-8">
        <p className="text-base leading-7">AI health tracker — log symptoms, track vitals and get personalised wellness insights.</p>
      </section>

      <section className="mb-8">
        <h2 className="text-lg font-semibold mb-3">What We Offer</h2>
        <p>
          MyVitals is a free service built to make health monitoring more accessible through the power of artificial intelligence.
      ...
      <section className="mb-8">
        ...
        <p>
          MyVitals is supported by advertising through Google AdSense. Ads help us keep the service
      ...
      <p className="mt-10 opacity-40 text-xs">© 2026 MyVitals. All rights reserved.</p>
    </main>
  );
}
