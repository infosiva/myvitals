...
export const metadata: Metadata = {
  title: "Privacy Policy | MyVitals",
  description: "Privacy policy for MyVitals — how we collect, use and protect your data.",
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      ...
      <Section title="1. Who We Are">
        <p>MyVitals (https://myvitals.app) is operated by an independent developer. AI health tracker — log symptoms, track vitals and get personalised wellness insights.</p>
