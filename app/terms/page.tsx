...
export const metadata: Metadata = {
  title: "Terms of Service | MyVitals",
  description: "Terms of service for MyVitals — your rights and responsibilities when using our service.",
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      ...
      <Section title="1. Acceptance of Terms">
        <p>
          By accessing or using MyVitals (https://myvitals.app), you agree to be bound by these Terms of Service.
          If you do not agree, please do not use the service.
        </p>
      </Section>

      <Section title="2. Description of Service">
        <p>AI health tracker — log symptoms, track vitals and get personalised wellness insights.</p>
        <p className="mt-2">
      ...
      <Section title="5. Intellectual Property">
        <p>
          All original content, design and code on this service is owned by or licensed to MyVitals.
      ...
      <Section title="9. Limitation of Liability">
        <p>
          To the fullest extent permitted by law, MyVitals shall not be liable for any indirect,
